...
public class BasePOIActivity extends FragmentActivity implements OnGetPoiSearchResultListener, OnGetSuggestionResultListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_base_poi);
        // 初始化搜索模块，注册搜索事件监听
    ...
    public void onGetPoiResult(PoiResult result) {
        if (result == null || result.error == SearchResult.ERRORNO.RESULT_NOT_FOUND) {
            Toast.makeText(BasePOIActivity.this, "未找到结果", Toast.LENGTH_LONG)
                    .show();
            return;
        }
        ...
        if (result.error == SearchResult.ERRORNO.AMBIGUOUS_KEYWORD) {
            ...
            strInfo += "找到结果";
            Toast.makeText(BasePOIActivity.this, strInfo, Toast.LENGTH_LONG)
                    .show();
        }
    }
    ...
    public void onGetPoiDetailResult(PoiDetailResult result) {
        if (result.error != SearchResult.ERRORNO.NO_ERROR) {
            Toast.makeText(BasePOIActivity.this, "抱歉，未找到结果", Toast.LENGTH_SHORT)
                    .show();
        } else {
            Toast.makeText(BasePOIActivity.this, result.getName() + ": " + result.getAddress(), Toast.LENGTH_SHORT)
                    .show();
        }
    }
    ...
    public void onGetSuggestionResult(SuggestionResult res) {
        ...
        sugAdapter = new ArrayAdapter<String>(BasePOIActivity.this, android.R.layout.simple_dropdown_item_1line, suggest);
        keyWorldsView.setAdapter(sugAdapter);
